...
@section('content')
    ...
    <form action="{{route('poste.update', $poste)}}" method="POST">
        ...
        <select name="region" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" value="{{$poste->region}}" required autocomplete="comuna" autofocus aria-label="Default select example">
        ...
        <select name="comuna" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" value="{{$poste->comuna}}" required autocomplete="comuna" autofocus aria-label="Default select example">
        ...
        <select name="estado" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" value="{{$poste->estado}}" required autocomplete="comuna" autofocus aria-label="Default select example">
