<div class="modal fade-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="deleteClima-{{$clima->id}}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: red; color:white; font-size: 20px">
                    ...
                    <h3 class="modal-title">Eliminar Clima</h3>
                </div>
                <div class="modal-body">
                    <p>Confirma que desea eliminar al Clima {{$clima->temperatura}} </p>
                </div>
